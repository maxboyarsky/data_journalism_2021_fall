...
**Answer** There are incompatible data types. There can't be a combination of double and character
...
```{r}
maryland_zcta <- maryland_zcta %>% mutate(across(ZCTA5N, as.double))
```
...
**Answer**
Average/Media for U:100197.98	25225	
Average/Media for R:81815.26	24675	
```{r}
