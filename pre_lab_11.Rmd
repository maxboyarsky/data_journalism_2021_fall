...
**Answer**
The name, the location including the longitude and latitude, 
```{r}
...
**Answer** The same data, but only for hospitals located in MD
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is now limited to just maryland hospitals specializing in general acute care. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Hospitals' longitude and lattitude
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's just the tigris package
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Only counties where the state fp is 24
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is the map from the previous question, but now the land clearly defined. There are no more points. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now it is still including the longitude and lattitude dots within the map of maryland. It helps the viewer clearly define where the dot is in relation to the state. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Provides a code for the number of beds within each hospital in Maryland. More beds are in yellow and less beds are in dark purple. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It is reading in the hospital data.shp. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Compares the county and the number of hospital beds within that county
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Population size within each county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Jusr the population estimate per county in the state of Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** County vs. Total Hospital beds in that county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now it's just the county, population, and the geometry
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Now it is the total beds per county per 100k people instead of total.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It has replaced Queen Anne's County and Carolina County, counties with no general acute care. 
```{r}
md_beds_per_100k <- md_county_population %>%
  left_join(md_beds_by_county) %>%
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now it is sorted in ascending order. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Well organized graph explaining the beds in each county per 100,000 people in the state of Maryland.The counties are divided geographically and they are color coded in relation to population size. 
```{r}
ggplot() + 
...
**Answer** Now it is saying the exact amount of beds per county
