...
**Answer**  The number of first and second doses by county by date. 
...
**Answer** The number of vaccinations by county are awfully similar to one another. 
...
**Answer** A lot of the sections are not available. It only shows the first dose. 
...
**Answer** the ranks are mostly in descending order
...
**Answer** The number of vaccinations are much higher earlier in the year in the months of April and May. 
...
**Answer** "The number of people in Prince George's County fully vaccinated on November 14 decreased by -74.25 percent compared to the week before"
```{r}
...
**Answer** The number of Covid cases over the span between 2020 and 2021 by Maryland county. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
This is a continuous map of Covid Cases
```{r}
...
**Answer** Current Covid cases as of the 15th of November in each county
