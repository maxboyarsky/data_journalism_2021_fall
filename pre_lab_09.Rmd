...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** Its a bar chart which shows the the total loans across maryland counties
...
**Answer**
 It put the data in ascending order.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
It flipped the data so that the graph is a horizontal bar chart.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Answer** It has a blue background and the gird contains only horzontal lines. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
1) There is a main title
2) y-axis' title has changed to "total loans"
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Comparison of the loan's approved date to the total number of loans 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Its a line chart which shows the number of loans approved on which date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates on the x axis are much closer together.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates are legible and not smushed together, they are coded at a slant. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
