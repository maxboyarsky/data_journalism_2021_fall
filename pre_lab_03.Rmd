...
**Answer**One or more parsing issues, see `problems()` for details
...
**Answer** This was reallymaking me mad because it wouldnt load
...
**Answer** Yes, 6 dollars is very small for a loan.
```{r}
...
**Answer** Problem with `summarise()` column `total_amount`. ℹ `total_amount = sum(amount)`. x invalid 'type' (character) of argument
