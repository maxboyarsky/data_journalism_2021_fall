...
**Answer** The spellings of the city names are all similar, but not the exact same, so they group them differently in the sheet. 
...
**Answer** It grouped most of the city names so that there weren't any duplicates and mispellings. This included fixes capitalizations and inconsistent abbreviations. 
