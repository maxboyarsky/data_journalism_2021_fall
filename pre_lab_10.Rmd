...
https://app.datawrapper.de/chart/UNbXD/publish
...
**Answer** It is isolating the county and the number of loans
...
**Answer** filtering by counties with less than 6 loans
...
It contains the fips code for each county
...
**Answer** https://app.datawrapper.de/map/bH1TN/publish 
