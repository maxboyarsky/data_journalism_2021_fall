...
**Answer** It shows federal politicians and their original tweets containing the words "COVID" or "Coronavirus".
...
**Answer** Converts the text to lowercase
...
**Answer** Converted everythin to lowercase and removed all punctuation. 
...
**Answer** It is mostly articles and basic words besides coronavirus and covid-19. 
...
**Answer** Yes, considering that all the stop words were filtered out. It reveals more of the depth of the content of the tweets. 
...
**Answer** It mostly consists of the same words, but in different order.
...
**Task** Run the following code and describe the results.
**Answer**I couldn't run this codeblock. 
...
**Task** Run the following code and describe the results.
**Answer**  They are still among the top 2-word phrases. 
...
**Task** Run the following code and describe the results.
**Answer** I couldn't run this codeblocks.
...
**Answer** Trump having an overwhelming number of positive counts seems incorrect, as I would assume it would be polarized. 
