...
**Answer**
Its an Industry Classification Overview and it is comparing Naics codes from 2012 to 2017. 
### Task 3: Load image
...
**Answer**
It's an outline of the code used to produce the webpage
...
**Answer** 
Its pulled the html and made it into a rows and columns data table
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
The code used is "th" which is table header. The class is used to make changes to the specific word or group of words. Class="subhead" 
...
**Answer** 
It is individual tables of data. It's not very organized
```{r}
...
**Answer**
Once I hit the scroll icon, it let me examine what the actual text in the file was. 
...
**Answer**
There is only the code we need in both columns 
...
**Answer**There are less description columns
...
**Answer**
It is the same table, but it was cleaned to have less rows and columns.
```{r}
...
**Answer**
Isolate of the employment number in June 2021
```{r}
