...
International_Migration_Maryland <- read_csv("data/tabula-md-statistical-handbook.csv",skip=2,
col_names=c("City","Yr2011", "Yr2012", "Yr2013", "Yr2014", "Yr2014", "Yr2016", "Yr2017", "Yr2018", "Yr2019", "total"))
...
International_Migration_Clean <- International_Migration_Maryland %>%
...
International_Migration_Clean %>%
  mutate(percent=total/198996) %>%
...
It is comparing the other state and city's totals to the state of Maryland's,
...
# Write the code to produce your answer here
International_Migration_Clean %>%
  mutate(percent_change=(Yr2018-Yr2017)/Yr2017) %>%
  arrange(percent_change)
```

**Q4** What's your best guess as to why these declines occurred, and in those area in particular?
**A4** [write your answer here]
I think maybe there were declines in these areas in particular because the towns are pretty far away from cites. 
...
```{r}
# Write the code to load the CSV file here
domestic_migration <- read_csv("data/tabula-md-statistical-handbook copy2.csv", skip=2,
col_names=c("City","Yr2011", "Yr2012", "Yr2013", "Yr2014", "Yr2014", "Yr2016", "Yr2017", "Yr2018", "Yr2019", "total"))
...
The Suburban Washington region stands out the most, but for cities, Baltimore has highest total number of migrants.
